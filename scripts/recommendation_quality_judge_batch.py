...
def build_parser() -> argparse.ArgumentParser:
    ...
    submit_parser.add_argument("--name", default="", help="Display name for a newly submitted Gemini Batch job.")
    submit_parser.add_argument("--job-file", default="", help="File used to reuse or store the Gemini Batch job name.")
    submit_parser.add_argument("--force", action="store_true", help="Submit a replacement job even when the job file already exists.")
    ...
    check_parser.add_argument("--job", default="", help="Gemini Batch job name. If omitted, read it from the job file.")
    check_parser.add_argument("--job-file", default="", help="File containing the Gemini Batch job name.")
    ...
    openai_submit_parser.add_argument("--jsonl", default="", help="Prepared OpenAI Batch JSONL. Defaults to the output-dir batch file.")
    openai_submit_parser.add_argument("--name", default="", help="Display name for a newly submitted OpenAI Batch job.")
    openai_submit_parser.add_argument("--job-file", default="", help="File used to reuse or store the OpenAI Batch job id.")
    openai_submit_parser.add_argument("--model", default=OPENAI_MODEL_NAME)
    openai_submit_parser.add_argument("--force", action="store_true", help="Submit a replacement job even when the job file already exists.")
    openai_submit_parser.add_argument("--validation-status-json", default="", help="Validation status JSON used to block new jobs after a stop decision.")
    openai_submit_parser.add_argument("--allow-after-validation-stop", action="store_true", help="Override a stop-sampling validation status for an intentional new submission.")
    openai_submit_parser.add_argument("--require-no-active", action="store_true", help="Refuse a new submission when another OpenAI Batch job is active.")
    openai_submit_parser.add_argument("--active-check-limit", type=int, default=20, help="Number of recent OpenAI Batch jobs to inspect for active statuses.")
    ...
    openai_check_parser.add_argument("--job", default="", help="OpenAI Batch job id. If omitted, read it from the job file.")
    openai_check_parser.add_argument("--job-file", default="", help="File containing the OpenAI Batch job id.")
    ...
    openai_run_parser.add_argument("--jsonl", default="", help="Prepared OpenAI Batch JSONL. Defaults to the output-dir batch file.")
    openai_run_parser.add_argument("--name", default="", help="Display name for a newly submitted OpenAI Batch job.")
    openai_run_parser.add_argument("--job-file", default="", help="File used to reuse or store the OpenAI Batch job id.")
    openai_run_parser.add_argument("--model", default=OPENAI_MODEL_NAME)
    openai_run_parser.add_argument("--force", action="store_true", help="Submit a replacement job even when the job file already exists.")
    openai_run_parser.add_argument("--validation-status-json", default="", help="Validation status JSON used to block new jobs after a stop decision.")
    openai_run_parser.add_argument("--allow-after-validation-stop", action="store_true", help="Override a stop-sampling validation status for an intentional new submission.")
    ...
    openai_run_parser.add_argument("--require-no-active", action="store_true", help="Refuse a new submission when another OpenAI Batch job is active.")
    openai_run_parser.add_argument("--active-check-limit", type=int, default=20, help="Number of recent OpenAI Batch jobs to inspect for active statuses.")
    ...
    openai_cancel_parser.add_argument("--job", default="", help="OpenAI Batch job id. If omitted, read it from the job file.")
    openai_cancel_parser.add_argument("--job-file", default="", help="File containing the OpenAI Batch job id.")
