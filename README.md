...
식품의약품안전처(식약처)의 두 가지 공식 공공데이터를 활용합니다.

| 데이터셋 | 제공기관 | 활용 내용 | 공공데이터포털 |
|----------|----------|-----------|--------------|
| **건강기능식품 품목분류정보** | 식품의약품안전처 | 전 제품의 품목명·제조사·기능성 카테고리·원료 구성 | [바로가기](https://www.data.go.kr/data/15059798/openapi.do) |
| **건강기능식품 기능성 원료인정 현황** | 식품의약품안전처 | 고시형·개별인정형 원료의 기능성 내용, 표준 원료명, 인정 기준 | [바로가기](https://www.data.go.kr/data/15058359/openapi.do) |
